...
$logFile = sys_get_temp_dir() . "/$jobId/$jobId.log";
$pidFile = sys_get_temp_dir() . "/$jobId/$jobId.pid";
...
while (true) {
    ...
    $currentContent = file($logFile, FILE_IGNORE_NEW_LINES);

    // Check if the file has been updated
    if ($currentContent !== $lastContent) {
        $lastContent = $currentContent;

        foreach ($currentContent as $line) {
